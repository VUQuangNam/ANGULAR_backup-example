...
import { VoucherService } from 'src/common/services/voucher.service';
...
@Component({
    selector: 'dunnio-information-order-create-warranty',
...
export class InformationOrderWarrantyComponent implements OnInit {
    constructor(
        ...
        this.keypress = setTimeout(
            async () => {
                try {
                    ...
                    this.employees = respone.code ? [] : respone.users;
