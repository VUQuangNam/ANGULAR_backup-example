...
import { CustomerService, RankService, StoreService, StaffService } from 'src/common/services';
import { TypesUtilsService } from 'src/common/utils';
import { BaseConfig } from 'src/config';

@Component({
    selector: 'dunnio-information-order-create-tailor',
...
export class InformationOrderTailorComponent implements OnInit {
    constructor(
    ...
    async ngOnInit() {
        ...
        const respone = await this.userService.list({
            skip: 0,
            limit: 500
        });
