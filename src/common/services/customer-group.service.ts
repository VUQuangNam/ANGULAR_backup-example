...
export class CustomerGroupService {
    headers: HttpHeaders;
    API_URI = environment.API_ADMIN_URI + '/v1/customer-group';
     ...
     */
    list(params: CustomerGroupFilter) {
        delete params.page;
     ...
     */
    create(requestBody: CustomerGroup) {
     ...
     * @param {Customer} requestBody
     */
    update(id: string, requestBody: CustomerGroup) {
